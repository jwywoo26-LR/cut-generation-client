      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
          ...
          {previewUrl ? (
            ...
            <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg h-96 flex items-center justify-center bg-white dark:bg-gray-800">
              <div className="text-center text-gray-500 dark:text-gray-400">
                <svg className="w-16 h-16 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <p className="text-sm">Select an image to begin</p>
              </div>
            </div>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {previewUrls.map((url, index) => (
              <div key={index} className="relative">
                <div className="space-y-4">
                  {/* Original Image */}
                  <div className="border-2 border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-700 p-4">
                    <div className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Original</div>
                    <img
                      src={url}
                      alt={`Original ${index + 1}`}
                      className="w-full h-64 object-contain rounded bg-white dark:bg-gray-800"
                    />
                  </div>

                  {/* Processed Image */}
                  {processedImageUrls[index] ? (
                    <div className="border-2 border-green-500 dark:border-green-600 rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-700 p-4">
                      <div className="text-sm font-semibold text-green-700 dark:text-green-300 mb-3">Processed ✓</div>
                      <img
                    ...
                    <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg h-64 flex items-center justify-center bg-gray-50 dark:bg-gray-700">
                      <div className="text-center text-gray-500 dark:text-gray-400">
                  ...
                  <button
                    ...
                    className={`absolute top-2 right-2 p-2 bg-red-600 hover:bg-red-700 text-white rounded-full transition-opacity shadow-lg ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
                    title="Remove image"
                  >
